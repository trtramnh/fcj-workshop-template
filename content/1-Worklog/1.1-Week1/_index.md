...
| 3 | - Learn about Cloud Computing and AWS overview <br> - Explore core AWS service categories and perform introductory hands-on labs: <br>&emsp; + Compute (Amazon EC2) <br>&emsp; + Storage (Amazon S3) <br>&emsp; + Networking (Amazon VPC) <br>&emsp; + Database (Amazon RDS) | 19/05/2026 | 19/05/2026 | [AWS Cloud Journey](https://cloudjourney.awsstudygroup.com/) <br> [AWS Overview](https://aws.amazon.com/what-is-aws/) |
...
| 5 | - Learn core concepts of Amazon EC2 and perform hands-on lab on EC2 setup: <br>&emsp; + AMI <br>&emsp; + Instance Types <br>&emsp; + EBS <br>&emsp; + Security Group <br>&emsp; + Key Pair <br>&emsp; + Elastic IP | 21/05/2026 | 21/05/2026 | [AWS Cloud Journey](https://cloudjourney.awsstudygroup.com/) <br> [Amazon EC2 Guide](https://docs.aws.amazon.com/ec2/) |
